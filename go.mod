module github.com/vinq1911/livekit-sip
...
replace github.com/pion/sdp/v2 => ./sdp

replace github.com/emiago/sipgo => github.com/livekit/sipgo v0.13.2-0.20240319152110-0b1be6f289ef
